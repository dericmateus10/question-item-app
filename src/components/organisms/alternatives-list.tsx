  ...
  return (
    <Card>
      ...
      <CardContent className='space-y-4'>
        {fields.map((field, index) => (
          ...
          >
            <div className='flex items-center justify-between'>
              <Label htmlFor={`alternatives.${index}.textMd`}>
            ...
            <Textarea
              ...
              className={cn(
                'min-h-[80px]',
                errors?.alternatives?.[index]?.textMd && 'border-destructive'
              )}
            />
            ...
            <div className='flex items-center space-x-2'>
              ...
              />
              <Label htmlFor={`alternatives.${index}.isCorrect`}>
                Alternativa correta
              </Label>
            </div>
            ...
            {errors?.alternatives?.[index]?.textMd && (
              <p className='text-sm text-destructive'>
                {errors.alternatives[index].textMd.message}
              </p>
            )}
          </div>
        ))}
        ...
        {errors?.alternatives &&
          typeof errors.alternatives === 'object' &&
          'message' in errors.alternatives && (
            <p className='text-sm text-destructive'>
