...
export const QuestionForm: React.FC = () => {
  ...
  const subFunctionsQuery = getSubFunctions(watchedFunctionId)
  const performanceStandardsQuery = getPerformanceStandards(watchedSubFunctionId)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <CascadingSelect
            ...
            label="Subfunção"
            control={form.control}
            options={subFunctionsQuery.data?.data || []}
          ...
          <CascadingSelect
            ...
            control={form.control}
            options={performanceStandardsQuery.data?.data || []}
      ...
      <AlternativesList control={form.control} errors={form.formState.errors} />
